        ...
        <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
          <label className="inline-block flex-1 sm:flex-none">
            <input
              ...
              disabled={isLoading}
            />
            <span className={`block w-full sm:w-auto text-center px-3 sm:px-4 py-2 ${!rows.length ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-400'} text-white rounded-md cursor-pointer transition text-sm sm:text-base ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}>
              Upload
            </span>
          </label>
          {rows.length > 0 && (
            <>
              <button
                type="button"
                className={`flex-1 sm:flex-none px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition text-sm sm:text-base ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
